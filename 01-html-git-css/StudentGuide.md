...
* [1.1 - Zen of Coding](./1.1/Zen_of_Coding.pptx)
* [1.2 - Git'n Pro with HTML/CSS](./1.2/Gitn_Pro_HTML_CSS.pptx)
* [1.3 - Heroes of CSS](./1.3/Heroes_of_CSS.pptx)

### Homework Activities

* [Build Your Portfolio Page (Recommended Homework)](./Homework/recommended-homework-assignment.md)
* [Build A Wireframe Layout (Easier Homework)](./Homework/easier-homework-assignment.md)

### Key Activities

* [MyFirstHTML](./1.1/03-MyFirstHTML)
* [HTML/CSS Layout](./1.2/06-HTML_CSS_Layout)
* [Float Layout](./1.3/09-FloatLayout-Activity)
* [Position Example](./1.3/10-CSS_PositionedLayout)
